...
export default function ContactPage() {
  ...
  return (
    <>
      ...
      {/*  PAGE HEADER                                                     */}
      {/* ================================================================ */}
      <section className="relative overflow-hidden bg-primary pt-28 pb-8 sm:pt-32 sm:pb-10 lg:pt-36 lg:pb-12">
        <div
          className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(255,255,255,0.08),transparent_70%)]"
          aria-hidden="true"
        />
        <Container className="relative z-10">
          <motion.h1
            ...
            className="font-heading text-[clamp(2rem,5vw,3.5rem)] font-bold leading-[1.1] tracking-tight text-white"
          >
            Contact Us
          </motion.h1>
        </Container>
